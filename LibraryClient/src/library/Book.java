...
public class Book implements Serializable{
    ...
    public String toString() {
        return ("Book{id="+this.id+", title='" + this.title + "', price=" + this.price + ", description='" + this.description + "', isbn='" + this.isbn + "', nbOfPage=" + this.nbOfPage + ", illustrations=" + this.illustrations);
    }
}
